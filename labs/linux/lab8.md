...
![imagen1](https://github.com/ximenaasantiagoo/laboratorios-aws/blob/main/images/linux/lab8/paso1.png?raw=true)
![imagen2](https://github.com/ximenaasantiagoo/laboratorios-aws/blob/main/images/linux/lab8/paso1.1.png?raw=true)
...
- Finalmente, ejecuté `ls -laR` para verificar de forma recursiva que todos los nuevos propietarios y grupos se aplicaron correctamente.
  ![imagen3](https://github.com/ximenaasantiagoo/laboratorios-aws/blob/main/images/linux/lab8/paso2.png?raw=true)
  ![imagen4](https://github.com/ximenaasantiagoo/laboratorios-aws/blob/main/images/linux/lab8/paso2.1.png?raw=true)
...
- Luego, creé el archivo `symbolic_mode_file` usando `sudo vi` y lo guardé con `:wq`, a este le apliqué el modo simbólico con `sudo chmod g+w` para otorgar permisos de escritura al grupo.
  ![imagen5](https://github.com/ximenaasantiagoo/laboratorios-aws/blob/main/images/linux/lab8/paso3.png?raw=true)
...
- Al final, verifiqué ambos cambios ejecutando `ls -l` para comprobar que las nomenclaturas de lectura, escritura y ejecución coincidieran con lo configurado.
  ![imagen6](https://github.com/ximenaasantiagoo/laboratorios-aws/blob/main/images/linux/lab8/paso3.1.png?raw=true)
...
- Finalmente, validé que la estructura interna y los privilegios asignados fueran correctos ejecutando los comandos `ls -laR Shipping` y `ls -laR Sales` de manera individual.
  ![imagen7](https://github.com/ximenaasantiagoo/laboratorios-aws/blob/main/images/linux/lab8/paso4.png?raw=true)
