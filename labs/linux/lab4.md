...
![imagen1](https://github.com/ximenaasantiagoo/laboratorios-aws/blob/main/images/linux/lab4/paso1.png?raw=true)
![imagen2](https://github.com/ximenaasantiagoo/laboratorios-aws/blob/main/images/linux/lab4/paso1.1.png?raw=true)
...
- Para registrar al primer usuario (arosalez) y configurar su credencial de acceso inicial, ejecuté secuencialmente los comandos `useradd` y `passwd` con privilegios de superusuario
    ![imagen3](https://github.com/ximenaasantiagoo/laboratorios-aws/blob/main/images/linux/lab4/paso2.png?raw=true)
- Verifiqué que el usuario se había integrado correctamente al sistema, ejecuté una lectura del archivo `/etc/passwd` aplicando un filtro con `cut` para mostrar únicamente la primera columna correspondiente a los       nombres de usuario
  ...
  ![imagen4](https://github.com/ximenaasantiagoo/laboratorios-aws/blob/main/images/linux/lab4/paso2.1.png?raw=true)
...
![imagen5](https://github.com/ximenaasantiagoo/laboratorios-aws/blob/main/images/linux/lab4/paso3.png?raw=true)
![imagen6](https://github.com/ximenaasantiagoo/laboratorios-aws/blob/main/images/linux/lab4/paso3.1.png?raw=true)
...
![imagen7](https://github.com/ximenaasantiagoo/laboratorios-aws/blob/main/images/linux/lab4/paso4.png?raw=true)
...
![imagen8](https://github.com/ximenaasantiagoo/laboratorios-aws/blob/main/images/linux/lab4/paso5.png?raw=true)
![imagen9](https://github.com/ximenaasantiagoo/laboratorios-aws/blob/main/images/linux/lab4/paso5.1.png?raw=true)
...
![imagen10](https://github.com/ximenaasantiagoo/laboratorios-aws/blob/main/images/linux/lab4/paso6.png?raw=true)
![imagen11](https://github.com/ximenaasantiagoo/laboratorios-aws/blob/main/images/linux/lab4/paso6.1.png?raw=true)
...
![imagen12](https://github.com/ximenaasantiagoo/laboratorios-aws/blob/main/images/linux/lab4/paso7.1.png?raw=true)
...
![imagen13](https://github.com/ximenaasantiagoo/laboratorios-aws/blob/main/images/linux/lab4/paso8.png?raw=true)
...
![imagen14](https://github.com/ximenaasantiagoo/laboratorios-aws/blob/main/images/linux/lab4/paso9.png?raw=true) 
![imagen15](https://github.com/ximenaasantiagoo/laboratorios-aws/blob/main/images/linux/lab4/paso9.1.png?raw=true)
...
- Al cambiar de identidad, la terminal se actualizó mostrando la estructura `[arosalez@ec2-user]$`. El indicador final confirmó que seguía posicionada dentro del directorio home del usuario administrador original,     lo cual verifiqué ejecutando `pwd`
  ![imagen16](https://github.com/ximenaasantiagoo/laboratorios-aws/blob/main/images/linux/lab4/paso10.png?raw=true)
...
![imagen17](https://github.com/ximenaasantiagoo/laboratorios-aws/blob/main/images/linux/lab4/paso11.png?raw=true)
...
![imagen18](https://github.com/ximenaasantiagoo/laboratorios-aws/blob/main/images/linux/lab4/paso12.png?raw=true)
...
![imagen19](https://github.com/ximenaasantiagoo/laboratorios-aws/blob/main/images/linux/lab4/paso13.png?raw=true)
![imagen19](https://github.com/ximenaasantiagoo/laboratorios-aws/blob/main/images/linux/lab4/paso13.1.png?raw=true)
